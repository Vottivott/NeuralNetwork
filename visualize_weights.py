...
if __name__ == "__main__":
    net = load_from_file("saved_networks/epoch_0_mini_batch_400.pkl")
    ...
    # im = plt.imshow(data, cmap=plt.get_cmap('afmhot'))
    im = plt.imshow(0.2+0.6*np.eye(28), cmap=plt.get_cmap('afmhot'))
    im.set_array(data)
    plt.colorbar()
